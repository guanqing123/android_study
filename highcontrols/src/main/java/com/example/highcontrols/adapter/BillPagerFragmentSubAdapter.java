...
public class BillPagerFragmentSubAdapter extends BaseAdapter {

    private Context context;
    private List<BillInfo> billInfos;
    public BillPagerFragmentSubAdapter(Context context, List<BillInfo> billInfos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_bill_list, null);
