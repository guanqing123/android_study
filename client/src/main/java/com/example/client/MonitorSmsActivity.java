...
public class MonitorSmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 如果发生数据变化的 Uri 为3。
        // 当 notifyForDescendents 为 false，那么该 ContentObserver 会监听不到，但是当 notifyForDescendents 为true, 那么该 ContentObserver 就会监听到。
    ...
    public void fillET(String sender, String body) {
        et_sender.setText(sender);
    ...
    private static class SmsGetObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, @Nullable Uri uri) {
            ...
            if (cursor.moveToNext()) {
                ...
                Log.d("gq", "phone: " + phone + " content: " + content);
                ((MonitorSmsActivity) context).fillET(phone, content);
            }
            cursor.close();
        }
    }
